...
const STR = {
  en: {
    ...
    "auth.signin_subtitle": "Please sign in to continue.",
    "auth.register_title": "Register",
    "auth.register_subtitle": "Create your account and choose your role.",
    "auth.social_or": "Or continue with",
    "auth.social_google": "Google",
    "auth.social_apple": "Apple",
    "auth.social_setup_required": "Google and Apple sign-in need OAuth setup first.",
    ...
    "auth.reset_intro": "Enter your email or phone, then use the 6-digit code from your email to set a new password.",
    "auth.reset_step_request_title": "Forgot password?",
    "auth.reset_step_request_copy": "Enter your account email or phone and we'll send a reset code.",
    "auth.reset_step_code_title": "Password reset code",
    "auth.reset_step_code_copy": "Enter the 6-digit code from your email.",
    "auth.reset_step_password_title": "Set new password",
    "auth.reset_step_password_copy": "Choose a new password for your GULIT account.",
    "auth.reset_code_required": "Enter the 6-digit reset code.",
    "auth.reset_request_btn": "Request reset",
    "auth.reset_sending": "Sending reset request...",
    "auth.reset_sent": "Reset instructions are ready.",
    "auth.reset_email_hint": "If this account exists, check your email inbox and spam folder for the 6-digit reset code.",
    "auth.reset_email_failed": "Reset code was created, but the email could not be sent. Check the backend email settings.",
    "auth.reset_token": "6-digit reset code",
