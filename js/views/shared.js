...
const STR = {
  en: {
    ...
    "auth.staff_note": "Owner, delivery, and committee accounts require a Work ID number. A Fayda FAN is generated for you automatically — you can replace it with your real number from Edit profile.",
  ...
  am: {
    ...
    "auth.staff_note": "የባለቤት፣ አስረካቢ እና ኮሚቴ መለያዎች የሥራ መታወቂያ ቁጥር ያስፈልጋቸዋል። የፋይዳ FAN በራስ-ሰር ይመረታል — ከ“መግለጫ አስተካክል” ላይ በትክክለኛው ቁጥር መቀየር ይችላሉ።",
